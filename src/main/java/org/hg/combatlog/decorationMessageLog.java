    ...
    public decorationMessageLog(List<TextComponent> messages, int page, int max_page) {
        ...
        if (page <= 4){
            for (int i = 1; i <= 7 && i <= max_page; i++){
                ...
                hover_page.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/combat_page "+i));
                if (page == i){
            ...
            if (max_page > 7) {
                ...
                hover_page.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/combat_page "+max_page));
            ...
            hover_page.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/combat_page 1"));
            str.addExtra(hover_page);
            str.addExtra(new TextComponent(ChatColor.RESET + " ... "));
